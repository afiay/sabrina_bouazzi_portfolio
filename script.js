...
const i18n = {
  fr: {
    ...
    cinemaImageNote: "Image placée ici : photo de plateau liée au travail de décor et de scénographie cinéma.",
    ...
    atelierDetailEyebrow: "Signature d’atelier",
    atelierDetailTitle: "Finitions, patine et identité visuelle.",
    atelierDetailText: "Chaque pièce valorise le détail, le toucher et la mémoire de la matière, avec une attention particulière portée aux finitions et à la présence de l’objet dans l’espace.",
  ...
  en: {
    ...
    cinemaImageNote: "Image placed here: behind-the-scenes set photo connected to cinema set design and scenography.",
    ...
    atelierDetailEyebrow: "Studio signature",
    atelierDetailTitle: "Finishes, patina and visual identity.",
    atelierDetailText: "Each piece highlights detail, tactility and the memory of the material, with special attention to finishing touches and the object’s presence in space.",
  ...
  ar: {
    ...
    cinemaImageNote: "تم وضع الصورة هنا لأنها صورة من كواليس العمل مرتبطة بديكور السينما والسينوغرافيا.",
    ...
    atelierDetailEyebrow: "هوية الورشة",
    atelierDetailTitle: "تشطيبات، باتينا وهوية بصرية.",
    atelierDetailText: "كل قطعة تبرز قيمة التفاصيل والملمس وذاكرة المادة، مع عناية خاصة بالتشطيبات وحضور الشيء داخل الفضاء.",
